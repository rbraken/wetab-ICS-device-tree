...
#include <utils/Log.h> //RB
extern "C" int posix_memalign(void **res, size_t align, size_t len) ;
#include <semaphore.h>
#include "bc_dts_glob_lnx.h"
#include "libcrystalhd_parser.h"
#include <pthread.h> //RB
...
#define LOG_TAG "Libcrystalhd"
#define DebugLog_Trace(_tl, fmt, args...)	LOGV(fmt, ##args);
#else
