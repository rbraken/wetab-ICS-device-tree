...
shmid =  shmget(123, 1024, 0644|IPC_CREAT|IPC_EXCL) ; 
DebugLog_Trace(LDIL_DBG,"shmid=%d errno=%d \n",shmid,errno);
shmid =  shmget(12345, 1024, 0644|IPC_CREAT|IPC_EXCL) ; 
DebugLog_Trace(LDIL_DBG,"shmid=%d errno=%d \n",shmid,errno);
...
#ifndef __APPLE__
	const char fwdir[] = "/system/lib/firmware/"; //RB
#else
